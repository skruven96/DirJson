...
static const char TestReadEmptyArray__Json[]    = "123";
static const char TestReadEmptyArray__Carrot[]  = "^  ";
static const char TestReadEmptyArray__Message[] = "Expected an array. ";
